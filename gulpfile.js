...
gulp.task('js', function () {
    return gulp.src('js/app.js') //because now we have a js folder
        .pipe(browser.browserify())  //browserify job is to coonvert require() into code browsers understand
        .pipe(gulp.dest('public/'));
});
...
gulp.task('watch', ['default'], function () {
    ...
    gulp.watch('js/*.js', ['js']);  //changed this to reflect all js files
});